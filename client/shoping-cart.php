                            ...
                            <tbody>
                                <tr>
                                    <td class="shoping__cart__item">
                                        <img src="img/cart/cart-1_1.jpg" alt="">
                                        <h5>Xương rồng sen đá mini kèm chậu</h5>
                                    </td>
                                ...
                                <tr>
                                    <td class="shoping__cart__item">
                                        <img src="img/cart/cart-1_2.jpg" alt="">
                                        <h5>Xương rồng trứng chim lớn</h5>
                                    </td>
                                    <td class="shoping__cart__price">
                                        29.000 VNĐ
                                    </td>
                                ...
                                <tr>
                                    <td class="shoping__cart__item">
                                        <img src="img/cart/cart-1_3.jpg" alt="">
                                        <h5>Xương rồng tai thỏ</h5>
                                    </td>
                                    <td class="shoping__cart__price">
                                        36.000 VNĐ
                                    </td>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="shoping__checkout">
                        ...
                        <a href="#" class="primary-btn">TIẾN HÀNH THANH TOÁN</a>
                    </div>
                </div>
            </div>
        </div>
